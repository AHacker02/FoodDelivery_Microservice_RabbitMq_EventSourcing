...
using OMF.CustomerManagementService.Command.Application.EventHandlers;
...
namespace OMF.CustomerManagementService.Command.Application
{
    public class CustomerModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CreateUserCommandHandler>().As<ICommandHandler<CreateUser>>();
            builder.RegisterType<DeleteUserEventHandler>().As<IEventHandler<DeleteUser>>();
        }
    }
}
